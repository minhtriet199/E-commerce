...
<section>
    <div class="container">
        <div class="mid-table">
            <form action="/user/link-reset" method="POST" >
                <h2>Quên mật khẩu</h2>
                @include('block.alert')
            ...
            <div class="row">
                    <h5 class="col-8" style="text-align:left;"><a href="/user/login">Đăng nhập</a></h5>
                    <h5 class="col-4" style="text-align:right;"><a href="/user/signup">Đăng ký</a></h5>
            </div>
            <hr>
            <div class="row">
